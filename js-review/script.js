...
const newGenres = ["epicFantasy", ...otherGenres];
...
const summary = `The ${title} is a book ${pages} long book written by ${author} and published on ${getYear(
  publicationDate
)}. The book has ${hasMovieAdaptation ? "" : "not"}been turned into a movie.`;
summary;
